...
class NotificationServiceHelper {
  static final _notificationService = NotificationServiceHelper._internal();
  factory NotificationServiceHelper() => _notificationService;
  NotificationServiceHelper._internal();
  ...
  displayNotification(
    ...
    final largeIcon = await downloadFile(
        '${Constants.Basic_URL}/profile/abbas.jpeg',
        'abbas');
  ...
  scheduledNotification(
      int hour, int minutes, int id, String title, String body) async {
